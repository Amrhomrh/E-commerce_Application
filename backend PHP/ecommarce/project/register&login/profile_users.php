...
<div class="container">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      ...
      <ul class="nav nav-pills">
        <li class="nav-item"><a href="page-users.php" class="nav-link active" aria-current="page">Home</a></li>
      ...
      <div class="col">
        <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="#"><?php  echo $_SESSION['id'];  
               ?></a></li>
        ...
        <div class="card mb-4">
          <div class="card-body  text-center">
           ...
           <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <h5 class="card-title"><?php echo htmlentities($result->users_name )   ?></h5>
                <br>
                <h6 class="text-muted mb-0"  ><?php echo htmlentities($result->users_email )?></h6>
                <br>
                <h6 class="text-muted mb-0"  ><?php echo htmlentities($result->users_phone )?></h6>
                <br>
        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-9">
              <input class="text-muted mb-0" name="users_name" value="<?php echo htmlentities($result->users_name )   ?>"></input>
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
              <input class="text-muted mb-0" name="users_email" value="<?php echo htmlentities($result->users_email )    ?>"></input>
              </div>
            </div>
            <hr>
            <div class="row">
              ...
              <div class="col-sm-9">
                <input class="text-muted mb-0" name="users_phone" value="<?php echo htmlentities($result->users_phone )   ?>"></input>
              </div>
            </div>
            <hr>
...
{
  $first_name=$_POST['users_name'];
  // $last_name=$_POST['last_name'];
  $email=$_POST['users_email'];
  $phone=$_POST['users_phone'];


$sql="UPDATE users set users_name=?, users_email=?,users_phone=? WHERE users_id='$id' ";
$update=$database->prepare($sql);
$update->execute([$first_name,$email, $phone]);
if($update->rowCount()>0){
  echo "<head>
 <meta http-equiv='refresh' content='0; URL=user_profile.php'>
 </head>";
// $sql_select="SELECT  users_name, users_email,users_phone FROM users WHERE user_id='1' ";
...
// }  
// else{
//     echo " <script> alert('لم يتم تغيير الصورة ')  </script>";
// }
...
//     echo " <script> alert('done up')  </script>";
...
//     echo " <script> alert('eroorr')  </script>";
