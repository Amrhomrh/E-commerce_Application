...
$sql="SELECT * FROM items WHERE items_id=$id ORDER BY items_id DESC ";
...
$views->execute();
    ...
    if ($counter % 4 == 0) {
      ...
      <div class="col-md-3 col-sm-6 my-3 my-md-0">
        <form action="cart_end.php" method="post">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                           ...
                           <div style="display: inline-flex;margin-top: 20px;">
                                    <form action="cart_end.php "  method="get" enctype="multipart/form-data">
                                            <input type="hidden" name="id" value="<?php echo htmlentities( $show['items_id']);
                                            $id=$_POST['id']?>">
                                        <button  name="add" class="btn btn-danger"  >add to cart</button>
