    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="#" class="nav-link px-4 text-secondary">Home</a></li>
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
              ...
              <div class="me-4">
            <!-- <img src="" class="rounded-circle " style="width: 50px;" alt="Avatar" /> -->
                 
                  <h5 class="mb-2"><strong><?php
                  
                  if($result){
                  echo htmlentities($result->users_name) ;
                  
                  
                  } else {

                    echo htmlentities('eroor') ;
...
<a href="cart_end.php" class="nav-item nav-link active">
                    <h5 class="px-5 cart">
                        ...
                        <?php
                                ...
                                // echo "<span id=\"cart_count\" class=\"text-warning bg-light\"> $select_carts</span>";
