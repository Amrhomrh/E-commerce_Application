...
$select_user = $database->prepare("SELECT * FROM admins WHERE email = ? ");
   ...
   if ($select_user->rowCount() > 0 ){
    ...
    "<head>
    <meta http-equiv='refresh' content='0; URL=register-admin.php'>
    </head>";
}else{
    ...
    if($_POST['password'] != $_POST['cpass']){
       ...
       "<head>
       <meta http-equiv='refresh' content='0; URL=firstPadmin.php'>
       </head>";
   }else{
       
       
    $sql="INSERT INTO `users` ( `first_name`, `last_name`, `phone`, `email`, `password`, `Id_role`,`user_img`) VALUES (:firstname, :lastname,:phone, :email, :password,'1',:id)";
...
?>
            ...
            <div id="layoutAuthentication_footer">
                <footer >
                    <?php
                    include ('C:\xampp\htdocs\project\register&login\footer.php');
