                                ...
                                <table id="datatablesSimple">
                                    ...
                                    foreach($views as $show):
                                       ...
                                       ?>
                                            ...
                                            <td><img src="<?php echo  'img/' . ($show ['img'] )?>" class="rounded-circle mb-1" style="width: 40px;"alt="Avatar" /></td>
                                           
                                           
                                            <td><div class="btn-group" role="group" aria-label="Button group with nested dropdown">
 
                                                
                                            <button type="submit" name="delete" value="<?php echo htmlentities($show ['id'])?>"   class="btn  btn-danger"  >delete </button>
                                            <button type="submit" name="active" value="<?php echo htmlentities($show ['id'])?>" class="btn btn-success" name="change">active</button>
                                            <button type="submit" name="deactive" value="<?php echo htmlentities($show ['id'])?>" class="btn btn-warning" name="change">deactive</button></td>
                                            <!-- <td> -->
                                            <!--  -->
                                        ...
                                        if(isset($_POST['delete'])){
                                            ...
                                            $qdel="  DELETE FROM admins WHERE id=' $userD' ";
                                                ...
                                                echo " <script> alert('jfuck up')  </script>";
                                                            ...
                                                            echo " <script> alert('no fuck up')  </script>";
                                                                                                    ...
                                                                                                    if(isset($_POST['active'])){
                                                                                                        ...
                                                                                                        $qAct="UPDATE admins set active='1' WHERE id=' $userA' ";
                                                                                                            ...
                                                                                                            echo " <script> alert('jfuck up')  </script>";
                                                                                                                        ...
                                                                                                                        echo " <script> alert('no fuck up')  </script>";
                                                                                                                                                                ...
                                                                                                                                                                if(isset($_POST['deactive'])){
                                                                                                                                                                    ...
                                                                                                                                                                    $qAct="UPDATE admins set active='0' WHERE id=' $userA' ";
                                                                                                                                                                    $Act=$database->prepare($qAct);
                                                                                                                                                                    $Act->execute();
                                                                                                                                                                    $Active=$Act->fetchObject();
